<template>
  <div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
    ...
    <el-dropdown :show-timeout="70" :hide-timeout="50" @command="onHandleCommandClick">
        ...
        {{ userInfos.avatar }}
				<img v-if="userInfos.avatar" :src="userInfos.avatar" class="layout-navbars-breadcrumb-user-link-photo mr5"/>
				<img v-else :src="logoMini" class="layout-navbars-breadcrumb-user-link-photo mr5"/>
				{{ userInfos.nickName === '' ? userInfos.userName : userInfos.nickName }}
...
import logoMini from '/@/assets/login-bg.svg';
